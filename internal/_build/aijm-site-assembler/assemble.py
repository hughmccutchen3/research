...
/* ================= PROVENANCE SEAL (.bseal) — ported from styles.css BURSBUILD-S16 =================
   The B mark + stacked text link on the cover; jumps to this piece's provenance section. */
.bseal-host{ position:relative; }
.bseal{ position:absolute; top:12px; right:14px; display:flex; align-items:stretch; gap:6px; text-decoration:none; z-index:5; }
.bseal .bmark{ display:block; width:26px; height:26px; border-radius:5px; animation:bglow 3s ease-out 1; }
.bseal .btext{ display:flex; flex-direction:column; justify-content:space-between; height:26px; }
.bseal .btext span{ font-family:Georgia,"Times New Roman",serif; font-size:10.5px; line-height:1.15; color:#e8d9ae; text-decoration:underline; text-underline-offset:2px; text-decoration-thickness:1px; text-decoration-color:rgba(201,163,61,.8); }
.bseal:hover .btext span{ color:#C9A33D; }
.bseal .btip{ position:absolute; top:calc(100% + 7px); right:0; white-space:nowrap; background:#0F172A; border:1px solid rgba(201,163,61,.6); color:#e8d9ae; font-size:10px; font-family:Georgia,serif; padding:4px 9px; border-radius:4px; opacity:0; transform:translateY(-3px); pointer-events:none; transition:opacity .18s ease, transform .18s ease; }
.bseal:hover .btip, .bseal:focus .btip{ opacity:1; transform:translateY(0); }
@keyframes bglow{ 0%{box-shadow:0 0 0 0 rgba(201,163,61,0);} 22%{box-shadow:0 0 10px 2px rgba(201,163,61,.75);} 55%{box-shadow:0 0 7px 1px rgba(201,163,61,.35);} 100%{box-shadow:0 0 0 0 rgba(201,163,61,0);} }
@media (prefers-reduced-motion:reduce){ .bseal .bmark{ animation:none; } }
...
<span class="topbar__draft">Published</span>
</div>
...
def build_pagefoot(current_n):
    ...
    prev_html = ('<a class="pager pager--prev" href="%s">&#8592; Part %d: %s</a>' % (prev_p["file"], prev_p["n"], prev_p["title"])) if prev_p else '<a class="pager pager--prev" href="/research_examples.html">&#8592; All Research</a>'
...
<meta name="description" content="Part %d of %d: %s. A decade of Bloomberg's predictive, generative and agentic AI systems, traced case by case from the published record.">
<meta name="robots" content="index,follow">
<link rel="canonical" href="https://burseraconsulting.com/how-bloomberg-used-ai/%s">
...
<meta property="og:url" content="https://burseraconsulting.com/how-bloomberg-used-ai/%s">
<meta property="og:image" content="https://burseraconsulting.com/how-bloomberg-used-ai/og-bloomberg-ai.jpg">
...
%s
<div class="site-coverband bseal-host">
  <a class="bseal" href="%s" aria-label="Provenance for this piece"><svg class="bmark" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" role="img" aria-hidden="true"><rect width="100" height="100" rx="18" fill="#0F172A" stroke="#C9A33D" stroke-width="4"/><text x="50" y="72" text-anchor="middle" font-family="Georgia,serif" font-weight="600" font-size="66" fill="#C9A33D">B</text></svg><span class="btext"><span>Bursera</span><span>Provenance</span></span><span class="btip">Provenance for this piece</span></a>
  ...
  <div class="site-coverband__body">
    ...
    <p class="site-coverband__meta">Hugh McCutchen &middot; Bursera Consulting &middot; September 2026 &middot; Published</p>
  </div>
</div>
...
%s
        ...
        ("#provenance" if n == 4 else "part-4.html#provenance"),
        n,
